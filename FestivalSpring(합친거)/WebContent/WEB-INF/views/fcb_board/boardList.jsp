...
<script type="text/javascript">
	...
	function goBoardDetail(board_num){				
		location.href = "/fcb_board/boardDetail.do?board_num="+ board_num;
	}
	
	/** 게시판 - 작성 페이지 이동 */
	function goBoardWrite(){		
		location.href = "/fcb_board/boardWrite.do";
	}
		...
		if(state == "SUCCESS"){
			...
			if(listLen >  0){
				...
				for(var a=0; a<listLen; a++){
					...
					var fcb_group_num 	= list[a].fcb_group_num;
					var m_nickname 		= list[a].m_nickname; 
					var fcb_title 		= list[a].fcb_title; 
					var fcb_content 		= list[a].fcb_content; 
					var fcb_hits 		= list[a].fcb_hits;
					var fcb_delete_yn 	= list[a].fcb_delete_yn; 
					var m_id 			= list[a].m_id;
					var fcb_insert_date 	= list[a].fcb_insert_date; 
					var fcb_update_date 	= list[a].fcb_update_date;
 ...
 <header>
        ...
        <div class="sub_commmunity">
            <div class="sub_title_area">
                <div class="list_title"><h2>|관리자게시판</h2><p><a href="main.html">HOME</a>><a href="suppage_community.html">커뮤니티</a>><a href="suppage_community.html">관리자게시판</a></p></div>  
            </div>

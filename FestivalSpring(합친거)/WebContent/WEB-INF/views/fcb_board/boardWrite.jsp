...
<script type="text/javascript">
	...
	function insertBoard(){
		...
		var fcb_title = $("#fcb_title").val();
		var fcb_content = $("#fcb_content").val();
...
<header>
	...
	<div id="container">
		<div class="inner">		
			<h2>게시글 작성</h2>
			<form id="boardForm" name="boardForm" action="fcb_board/insertBoard" enctype="multipart/form-data" method="post" onsubmit="return false;">
				...
				<caption><strong><span class="t_red">*</span> 표시는 필수입력 항목입니다.</strong></caption>
				    ...
				    <tbody id="tbody">
						...
						<tr>
							...
							<td><textarea id="fcb_content" name="fcb_content" cols="10" rows="5" class="textarea01"></textarea></td>
						</tr>
						<tr>

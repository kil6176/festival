...
<script type="text/javascript">
	...
	function getBoardDetail(board_num){
		...
		if(board_num != ""){
			...
			$.ajax({	
			    ...
			    url		: "/mvb_board/getBoardDetail.do",
	...
	function getBoardDetailCallback(obj){
		...
		if(obj != null){								
			...
			var mvb_group_num 	= obj.mvb_group_num;
			var mvb_answer_deep 		= obj.mvb_answer_deep; 
			var mvb_answer_order 		= obj.mvb_answer_order;
			var m_nickname 		= obj.m_nickname; 
			var mvb_title 		= obj.mvb_title; 
			var mvb_content 		= obj.mvb_content; 
			var mvb_hits 		= obj.mvb_hits;
			var mvb_delete_yn 	= obj.mvb_delete_yn; 
			var m_id 			= obj.m_id;
			var mvb_insert_date 	= obj.mvb_insert_date; 
			var mvb_update_date 	= obj.mvb_update_date;
			var files			= obj.files;		
			var filesLen		= files.length;
								
			$("#mvb_title").val(mvb_title);			
			$("#mvb_content").val(mvb_content);
			...
			if(filesLen > 0){
				...
				for(var a=0; a<filesLen; a++){
					...
					fileStr += "<a href='/mvb_board/fileDownload.do?bf_name_key="+encodeURI(bf_name_key)+"&bf_name="+encodeURI(bf_name)+"&bf_path="+encodeURI(bf_path)+"'>" + bf_name + "</a>";
	...
	function updateBoard(){
		...
		var boardSubject = $("#mvb_title").val();
		var boardContent = $("#mvb_content").val();
...
<div id="wrap">
	<div id="container">
		<div class="inner">	
			<h2>게시글 상세</h2>
			<form id="boardForm" name="boardForm" action="/mvb_board/updateBoard" enctype="multipart/form-data" method="post" onsubmit="return false;">	
				    ...
				    <tbody id="tbody">
				       <tr>
						...
						<tr>
							...
							<td colspan="3"><textarea id="mvb_content" name="mvb_content" cols="50" rows="5" class="textarea01"></textarea></td>
						</tr>
						<tr>
							<th>첨부파일</th>

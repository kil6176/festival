...
<script type="text/javascript">
	...
	function goBoardUpdate(){
		...
		location.href = "/mvb_board/boardUpdate.do?board_num="+ board_num;
	}
	/** 게시판 - 답글 페이지 이동 */
	function goBoardReply(){
		...
		location.href = "/mvb_board/boardReply.do?board_num="+ board_num;
	}
	/** 게시판 - 첨부파일 다운로드 */
	function fileDownload(bf_name_key, bf_name, bf_path){
			
		location.href = "/mvb_board/fileDownload.do?bf_name_key="+bf_name_key+"&bf_name="+bf_name+"&bf_path="+bf_path;
	}
	...
	function getBoardDetailCallback(obj){
		...
		if(obj != null){								
			...
			str += "<tr>";
			str += "<th>내용</th>";
			str += "<td colspan='3'>"+ mvb_content +"</td>";
			str += "</tr>";
			...
			if(filesLen > 0){
				...
				for(var a=0; a<filesLen; a++){
					...
					str += "<td colspan='3'><a href='/mvb_board/fileDownload.do?bf_name_key="+encodeURI(bf_name_key)+"&bf_name="+encodeURI(bf_name)+"&bf_path="+encodeURI(bf_path)+"'>" + bf_name + "</a></td>";
					str += "</tr>";
				}	
			}			

...
<script type="text/javascript">
	...
	function goBoardDetail(board_num){				
		location.href = "/fcvb_board/boardDetail.do?board_num="+ board_num;
	}
	
	/** 게시판 - 작성 페이지 이동 */
	function goBoardWrite(){		
		location.href = "/fcvb_board/boardWrite.do";
	}
	...
	function getBoardList(currentPageNo){
		...
		$.ajax({	
		    ...
		    url		:"/fcvb_board/getBoardList.do",
		...
		if(state == "SUCCESS"){
			...
			if(listLen >  0){
				...
				for(var a=0; a<listLen; a++){
					...
					var fcvb_group_num 	= list[a].fcvb_group_num;
					var fcvb_answer_deep 		= list[a].fcvb_answer_deep; 
					var fcvb_answer_order 		= list[a].fcvb_answer_order;
					var m_nickname 		= list[a].m_nickname; 
					var fcvb_title 		= list[a].fcvb_title; 
					var fcvb_content 		= list[a].fcvb_content; 
					var fcvb_hits 		= list[a].fcvb_hits;
					var fcvb_delete_yn 	= list[a].fcvb_delete_yn; 
					var m_id 			= list[a].m_id;
					var fcvb_insert_date 	= list[a].fcvb_insert_date; 
					var fcvb_update_date 	= list[a].fcvb_update_date;
					...
					if(fcvb_answer_deep > 0){
						
						for(var b=0; b<fcvb_answer_deep; b++){

...
<script type="text/javascript">
	...
	function getBoardDetailCallback(obj){
		...
		if(obj != null){								
			...
			$("#fcvb_title").val(fcvb_title);			
			$("#fcvb_content").val(fcvb_content);
			...
			if(filesLen > 0){
				...
				for(var a=0; a<filesLen; a++){
					...
					fileStr += "<a href='/fcvb_board/fileDownload?bf_name_key="+encodeURI(bf_name_key)+"&bf_name="+encodeURI(bf_name)+"&bf_path="+encodeURI(bf_path)+"'>" + bf_name + "</a>";
	...
	function updateBoard(){
		...
		var boardSubject = $("#fcvb_title").val();
		var boardContent = $("#fcvb_content").val();
...
<div id="wrap">
	<div id="container">
		<div class="inner">	
			<h2>게시글 상세</h2>
			<form id="boardForm" name="boardForm" action="/fcvb_board/updateBoard.do" enctype="multipart/form-data" method="post" onsubmit="return false;">	
				    ...
				    <tbody id="tbody">
				       <tr>
						...
						<tr>
							...
							<td colspan="3"><textarea id="fcvb_content" name="fcvb_content" cols="50" rows="5" class="textarea01"></textarea></td>
						</tr>
						<tr>
							<th>첨부파일</th>

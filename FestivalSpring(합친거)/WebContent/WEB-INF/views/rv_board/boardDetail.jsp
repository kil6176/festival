...
<script type="text/javascript">
	...
	function goBoardList(){				
		location.href = "/rv_board/boardList.do";
	}
	...
	function goBoardUpdate(){
		...
		location.href = "/rv_board/boardUpdate.do?board_num="+ board_num;
	}
	
	/** 게시판 - 첨부파일 다운로드 */
	function fileDownload(bf_name_key, bf_name, bf_path){
			
		location.href = "/rv_board/fileDownload.do?bf_name_key="+bf_name_key+"&bf_name="+bf_name+"&bf_path="+bf_path;
	}
	...
	function getBoardDetail(board_num){
		...
		if(board_num != ""){
			...
			$.ajax({	
			    ...
			    url		: "/rv_board/getBoardDetail.do",
		...
		if(obj != null){								
			...
			if(filesLen > 0){
				...
				for(var a=0; a<filesLen; a++){
					...
					str += "<td colspan='3'><a href='/rv_board/fileDownload.do?bf_name_key="+encodeURI(bf_name_key)+"&bf_name="+encodeURI(bf_name)+"&bf_path="+encodeURI(bf_path)+"'>" + bf_name + "</a></td>";
					str += "</tr>";
				}	
			}			
...
<header>
        ...
        <div class="sub_commmunity">
            <div class="sub_title_area">
                <div class="list_title"><h2>|축제리뷰게시판</h2><p><a href="main.html">HOME</a>><a href="suppage_community.html">커뮤니티</a>><a href="suppage_community.html">축제리뷰게시판</a></p></div>  
            </div>

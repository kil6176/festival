...
public class FileDownloadUtil extends AbstractView {
    ...
    protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String fileNameKey 	= (String) fileInfo.get("bf_name_key");	// 암호화된 파일명(실제 저장된 파일 이름)
        String fileName 	= (String) fileInfo.get("bf_name");	// 원본 파일명(화면에 표시될 파일 이름)
        String filePath 	= (String) fileInfo.get("bf_path");	// 파일 경로

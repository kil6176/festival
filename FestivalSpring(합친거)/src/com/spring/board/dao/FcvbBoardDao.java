...
@Repository
public class FcvbBoardDao {

	@Resource(name = "sqlSession")
	private SqlSession sqlSession;

	private static final String NAMESPACE = "com.spring.board.fcvbBoardMapper";

	/** 게시판 - 목록 수 */
	public int getBoardCnt(FcvbBoardForm boardForm) throws Exception {

		return sqlSession.selectOne(NAMESPACE + ".getBoardCnt", boardForm);
	}

	/** 게시판 - 목록 조회 */
	public List<FcvbBoardDto> getBoardList(FcvbBoardForm boardForm) throws Exception {

		return sqlSession.selectList(NAMESPACE + ".getBoardList", boardForm);
	}

	/** 게시판 - 조회 수 수정 */
	public int updateBoardHits(FcvbBoardForm boardForm) throws Exception {
	...
	/** 게시판 - 그룹 번호 조회 */
	public int getFcvbGroupNum (FcvbBoardForm boardForm) throws Exception {

		return sqlSession.selectOne(NAMESPACE + ".getFcvbGroupNum", boardForm);
	}
	
	/** 게시판 - 등록 */
	public int insertBoard(FcvbBoardForm boardForm) throws Exception {
	...
	/** 게시판 - 등록 실패(트랜잭션 테스트) */
	public int insertBoardFail(FcvbBoardForm boardForm) throws Exception {
		return sqlSession.insert(NAMESPACE + ".insertBoardFail", boardForm);
	}

	/** 게시판 - 삭제 */
	public int deleteBoard(FcvbBoardForm boardForm) throws Exception {

		return sqlSession.delete(NAMESPACE + ".deleteBoard", boardForm);
	}

	/** 게시판 - 수정 */
	public int updateBoard(FcvbBoardForm boardForm) throws Exception {

		return sqlSession.update(NAMESPACE + ".updateBoard", boardForm);
	}
	
	/** 게시판 - 답글 정보  조회 */
	public FcvbBoardDto getBoardReplyInfo(FcvbBoardForm boardForm) throws Exception {
		return sqlSession.selectOne(NAMESPACE + ".getBoardReplyInfo", boardForm);
	}
	
	/** 게시판 - 답글의 순서 수정 */
	public int updateBoardReSeq(FcvbBoardForm boardForm) throws Exception {

		return sqlSession.update(NAMESPACE + ".updateBoardReSeq", boardForm);
	}
	
	/** 게시판 - 답글 등록 */
	public int insertBoardReply(FcvbBoardForm boardForm) throws Exception {
